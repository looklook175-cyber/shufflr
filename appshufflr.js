...
'empty.noPlaylistsPlaylistTab':'No playlists yet.',
...
'empty.noPlaylistsPlaylistTab':'Aún no hay listas.',
...
'empty.noPlaylistsPlaylistTab':'Pas encore de playlists.',
...
'empty.noPlaylistsPlaylistTab':'Nenhuma playlist ainda.',
...
'empty.noPlaylistsPlaylistTab':'プレイリストはまだありません。',
...
function renderYourShowPopup(showName,seasons,posterPath,overview){
  ...
  popup.innerHTML=`
    ...
    <div class="pl-drawer-actions">
      ...
      <button onclick="removeYourShowFromPopup()" style="background:none;border:none;color:#ff4444;font-family:'Press Start 2P',monospace;font-size:8px;cursor:pointer;padding:8px 0 0 0;display:block;">✕ Remove Show</button>
    </div>
